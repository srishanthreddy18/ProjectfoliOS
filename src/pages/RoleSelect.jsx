  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden"
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto animate-fadeIn flex flex-col items-center">
        ...
        {/* Auth Links */}
        <div className="flex gap-3 mt-8 animate-slideUp" style={{ animationDelay: '350ms' }}>
          <button
            onClick={() => navigate("/login")}
            className="flex-1 py-2 px-4 rounded-lg text-sm font-semibold transition-all hover:scale-105 active:scale-95"
          ...
          <button
            ...
            className="flex-1 py-2 px-4 rounded-lg text-sm font-semibold transition-all hover:scale-105 active:scale-95"
            style={{ background: "rgba(99,102,241,0.25)", color: "#c4b5fd", border: "1px solid rgba(99,102,241,0.5)" }}>
            ✨ Sign Up
          </button>
        </div>

        <p className="text-slate-600 text-xs mt-6 animate-slideUp" style={{ animationDelay: '400ms' }}>Or use demo access below</p>
      </div>
    </div>
  );
}
